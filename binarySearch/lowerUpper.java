public class lowerUpper {
    ...
    public static int justLower(int[] a, int x) {
    ...
    public static int upperBound(int[] a, int x) {
        // first element found is greater than x
        int lo = 0;
        int hi = a.length - 1;
        int ans = a.length;
        while (lo <= hi) {
    ...
    public static void main(String[] args) {
        ...
        if (jindex == arr.length) {
            ...
            System.out.println("Just Lower: index:" + jindex + ", val: " + arr[jindex]);
        }
